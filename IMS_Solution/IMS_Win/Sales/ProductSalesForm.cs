    ...
    public partial class ProductSalesForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                master_1.SaleMaster_PaidAmount = Convert.ToDecimal(txtPaid.Text);
                master_1.SaleMaster_DueAmount = Convert.ToDecimal(txtDue.Text);
                master_1.SaleMaster_TotalDue = pre_due;
                master_1.Status = "A";
                ...
                //lstMasterList = new List<Tbl_SalesMaster>();
        ...
        private void productListView_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == 13)
                {
                    ...
                    //{
                    //    txtAvailable.Text = "0";
                    //    UtilityBusiness.DisplayAlertMessage('W', "This Product Not Found In Stock!");
                    //}
