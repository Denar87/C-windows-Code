...
namespace Utility
{
  public  class AmountFormatBusiness
    {
        static StringBuilder sb;

        public static string GetTakaInWords(double amount, string prefix, string suffix)
        {
        ...
        public static string SetCommaInAmount(double amount, string prefix, string suffix)
        {
            if (amount == 0) return "";
        ...
        public static string GetTakaInWords(decimal amount, string prefix, string suffix)
        {
            return GetTakaInWords(double.Parse(amount.ToString()), prefix, suffix);
        }

        public static string SetCommaInAmount(decimal amount, string prefix, string suffix)
        {
        ...
        private static string FormatWithinCrore(string amount)
        {
        ...
        private static void GetValueWithoutPaisa(double amount, ref string paisa, ref string withoutPaisa)
        {
            paisa = "";
        ...
        private static void CalculatrBelowCrore(double value)
        {
            int dividedBy;
            int tmpVal;
        ...
        private static string LessHundred(int value)
        {
            if (value >= 100) return "";
            else if (value < 20)
            {
        ...
        private static string Get1to19(int value)
        {
            switch (value)
            {
                case 0:
        ...
        private static string GetTenth(int value)
        {
            switch (value)
            {
                case 2:
